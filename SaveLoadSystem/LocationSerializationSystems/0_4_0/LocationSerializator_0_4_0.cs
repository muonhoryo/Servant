...
namespace Servant.Serialization
{
    ...
    {
        private sealed class LocationSerializator_0_4_0 : LocationSerializator 
        {
            public LocationSerializator_0_4_0() : base() { }
            public LocationSerializator_0_4_0(ILocationSettings locationSettings,ISerializableObjectData[] data):
